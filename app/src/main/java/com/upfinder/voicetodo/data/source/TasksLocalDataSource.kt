...
import com.upfinder.voicetodo.data.TasksDao
...
class TasksLocalDataSource private constructor(
    ...
    override fun saveTask(task: Task) {
     ...
     fun update(task: Task) {
        appExecutors.diskIO.execute { tasksDao.updateTask(task) }
    }

    override fun completeTask(task: Task) {
        appExecutors.diskIO.execute { tasksDao.updateHasReminder(task.id, true) }
    }
    ...
    override fun activateTask(task: Task) {
        appExecutors.diskIO.execute { tasksDao.updateHasReminder(task.id, false) }
    }
